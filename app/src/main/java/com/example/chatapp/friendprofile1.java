        ...
        mreference.child("Users").child(friendid).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (!task.isSuccessful()) {
                    Toast.makeText(friendprofile1.this, "Error" + task.getException(), Toast.LENGTH_LONG).show();
                } else {
                    ...
                    Picasso.with(friendprofile1.this).load(image).resize(160, 160).into(imgProfile);
                ...
                if (snapshot.exists()) {
                    if (snapshot.child("status").getValue().toString().equals("pending")) {
                        ...
                        btn.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(friendprofile1.this, "User already Sent the Request", Toast.LENGTH_SHORT).show();
                            }
                        });
...
//                startActivity(new Intent(friendprofile1.this, com.example.chatapp.MainActivity.class));
//                finish();
//            }
//        });
        say_hi_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (current_stat.equals("nothing_happend")) {
                    ...
                    reqreference.child(friendid).child(userid).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(friendprofile1.this, "You have Send Friend Request", Toast.LENGTH_SHORT).show();
                                say_hi_view.setText("Requested");
                                ...
                                Toast.makeText(friendprofile1.this, "" + task.getException().toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                if (current_stat.equals("I_sent_pending") || current_stat.equals("I_sent_decline")) {
                    ...
                    reqreference.child(friendid).child(userid).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(friendprofile1.this, "You have cancelled Friend Request", Toast.LENGTH_SHORT).show();
                ...
                if (current_stat.equals("he_sent_pending")) {
                    Toast.makeText(friendprofile1.this, "User already sent request", Toast.LENGTH_SHORT).show();
                }
